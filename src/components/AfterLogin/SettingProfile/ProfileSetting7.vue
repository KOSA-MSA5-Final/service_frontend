            ...
            <div class="diseaseContainer">
                ...
                >
                    <img
                        width="50"
                        height="50"
                        src="https://img.icons8.com/ios-filled/50/stomach.png"
                        alt="stomach"
                    /><br />
                    소화기계통
                </div>
                ...
                >
                    <img
                        width="50"
                        height="50"
                        src="https://img.icons8.com/ios/50/flex-biceps.png"
                        alt="flex-biceps"
                    /><br />
                    근골격계통
                </div>
                ...
                >
                    <img
                        width="50"
                        height="50"
                        src="https://img.icons8.com/ios-filled/50/neuron.png"
                        alt="neuron"
                    /><br />
                    신경계통
                </div>
